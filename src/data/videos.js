...
export const videosBase = [
  ...
  {
    id: 'v02',
    titulo: 'Introducción al límite: ejemploss',
    descripcion: 'En esta clase definimos el concepto del límite y se resuelven ejemplos de límites determinados para algunas funciones.Clases para perder el miedo a las matemáticas.',
    youtubeId: 'https://www.youtube.com/watch?v=Kpor35P1NIQ',
    unidad: 'limites',
    tema: '1.3',
    duracion: '3:04',
    nivel: 'basico',
